"""update linebot prompts with delivery schedule tools
...
- update_delivery_schedule: 更新發包狀態/到貨日
...
- update_delivery_schedule: 更新發包記錄（可用廠商+料件匹配，更新狀態/到貨日等）
...
def downgrade() -> None:
    ...
    若需要完整回滾，請參考 024_update_linebot_prompts_auto_binding.py 中的
