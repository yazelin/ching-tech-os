"""update linebot prompts with history awareness

Revision ID: 020
Revises: 019
Create Date: 2026-01-07

新增對話歷史注意事項，讓 AI 更注意用戶的糾正和更正，
避免重複已經被糾正的錯誤說法。
"""
...
def downgrade() -> None:
    # 回滾到 019 版本的 prompt（不含對話歷史注意事項）
    # 這裡省略完整內容，實際回滾時會從 019 重新執行
    pass
