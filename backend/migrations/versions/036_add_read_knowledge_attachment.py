"""add read_knowledge_attachment tool to prompts
...
更新說明：
- 新增 read_knowledge_attachment 工具說明
- 讓 AI 可以讀取知識庫附件的內容（文字檔如 json/yaml/md 會返回內容）
"""
...
def downgrade() -> None:
    # 回滾到 035 版本的 prompt（不包含 read_knowledge_attachment）
    pass
