...
allowed-tools: mcp__erpnext__list_documents mcp__erpnext__get_document mcp__erpnext__create_document
  ...
  mcp__erpnext__get_stock_balance mcp__erpnext__get_stock_ledger mcp__erpnext__get_item_price
  mcp__erpnext__make_mapped_doc mcp__erpnext__get_party_balance mcp__erpnext__get_supplier_details
  mcp__erpnext__get_customer_details mcp__erpnext__upload_file mcp__erpnext__upload_file_from_url
