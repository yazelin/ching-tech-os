# mobile-app-layout Specification

## Purpose
TBD - created by archiving change update-mobile-app-layouts. Update Purpose after archive.
## Requirements
...
系統 SHALL 在手機版提供堆疊式導航（Stack Navigation），並將 skill 管理流程統一為單欄堆疊流程（列表 → 詳情 → 操作）。
