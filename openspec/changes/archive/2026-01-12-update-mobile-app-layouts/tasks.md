...
- [x] CSS：手機版列表全寬（`.pm-list-panel { width: 100% }`）
- [x] CSS：詳情頁堆疊動畫（`.showing-detail` + `transform`）
- [x] JS：返回按鈕邏輯（`hideMobileDetail()`）
- [x] CSS：內部 Tab（概覽/成員/會議...）橫向滾動
- [x] CSS：成員卡片、會議卡片、附件卡片、連結卡片手機版適配
- [x] 測試
...
- [x] CSS：預覽面板手機版處理（隱藏側邊預覽、檔案列表全寬）
- [x] CSS：工具列優化（隱藏文字、觸控區域 44px）
- [x] JS：預覽改為全螢幕 modal（含下載、分享按鈕）
- [x] 測試
...
- [x] iPhone SE (375px) 正常顯示
- [x] iPhone 14 (390px) 正常顯示
- [x] iPad 直立 (768px) 切換正確
- [x] 觸控區域 ≥ 44px
- [x] 無非預期水平滾動
- [x] 深色/淺色主題正常
